...
public class Driver {
    ...
    public static WebDriver getDriver() {
        ...
        if (driverPool.get() == null) {
            ...
            switch(browserName){
                case "remote-chrome": //for CI-CD --> i run my test cases in another machine(remote) in aws web servers called jenkins tool
                    try { //--> running my test cases in remote servers
